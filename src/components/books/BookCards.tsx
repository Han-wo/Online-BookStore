...
export default function BookCard({ book }: BookCardProps) {
  ...
  return (
    <>
      <button
        type="button"
        className="shadow-sm hover:shadow-md w-full rounded-lg border bg-white px-6 py-8 text-left transition-shadow"
      ...
      >
        ...
        >
          ...
          <Button
            ...
            className="flex items-center gap-5 text-red-600 hover:bg-red-50"
          >
